...
public abstract class PropertyEnricher<TContext>:IEnricher<TContext>
{
    ...
    protected PropertyEnricher(string propertyName, Func<TContext, object> propertyValueFactory, bool overwrite = false) : this(propertyName, propertyValueFactory,null, overwrite)
    {
    }

    protected PropertyEnricher(string propertyName,Func<TContext,object> propertyValueFactory,Func<TContext,bool>? propertyPredict,bool overwrite=false)
    {
